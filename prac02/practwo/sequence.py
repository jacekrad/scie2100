...
#    alphabet = None
    ...
    def calcSubstMatrix(self, background = None):
        ...
        # seqPairs is the total number of possible combinations
        # of two amino acid alignments in all given sequences it can be written as
        #    numSeqs!       1
        # -------------- * ---
        # (numSeqs - 2)!    2
        #
        ...
        # detailed explanation is already given in question 2
        for a in aminoAcids:
            for b in aminoAcids:
                # eaa = pa^2
                if a == b:
